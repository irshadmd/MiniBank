            ...
            <div class="myprofile">
              <form method="POST" action="addmemberdata.php" name="addmember">
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input type="text" class="form-control" value="<?php $str_result = '0123456789'; $ranid=substr(str_shuffle($str_result),0,6);
                          $memberId='MB'.$ranid; echo $memberId; ?>" name="memberid" id="memberid" readonly>
                      </div>
                  </div>
                  <div class="form-group row">
